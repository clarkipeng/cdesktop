...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::workspace::WorkspaceSource::decl(),
        db::models::routine::Routine::decl(),
        db::models::routine::CreateRoutine::decl(),
        db::models::routine::UpdateRoutine::decl(),
        db::models::routine::ScheduleKind::decl(),
        db::models::routine_run::RoutineRun::decl(),
        db::models::routine_run::RoutineRunStatus::decl(),
        server::routes::routines::RunNowResponse::decl(),
        ...
        utils::approvals::ApprovalPatterns::decl(),
        utils::approvals::ApprovalScope::decl(),
        ...
        db::provider_payloads::ClaudePayload::decl(),
        db::provider_payloads::CodexPayload::decl(),
        db::provider_payloads::OpencodePayload::decl(),
        db::provider_payloads::DeepseekTuiPayload::decl(),
        db::provider_payloads::GeminiPayload::decl(),
        db::provider_payloads::HermesPayload::decl(),
        ...
        db::models::requests::ReorderPinsRequest::decl(),
        ...
        db::models::session_command::SessionCommand::decl(),
        db::models::session_command::SessionCommandConfig::decl(),
        db::models::session_command::SessionCommandIntent::decl(),
        db::models::session_command::SessionCommandState::decl(),
        db::models::metered_approval::MeteredApproval::decl(),
        db::models::metered_approval::MeteredApprovalPolicy::decl(),
        db::models::metered_approval::MeteredApprovalState::decl(),
        db::models::metered_approval::MeteredExecution::decl(),
        db::models::execution_process_outcome::ExecutionProcessOutcome::decl(),
        ...
        executors::executors::claude::types::PermissionMode::decl(),
