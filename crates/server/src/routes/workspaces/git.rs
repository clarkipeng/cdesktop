...
async fn resolve_cdesktop_identifier(
...
pub async fn merge_workspace(
    ...
    let commit_message = format!("{} (cdesktop {})", workspace_label, vk_id);
    ...
    // Only archive once every attached repo has been merged (direct or via a
